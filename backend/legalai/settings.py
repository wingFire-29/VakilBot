...
LEGAL_DATA_PATH = BASE_DIR / 'legal_data'

# --- PRODUCTION SETTINGS ---
# Use PostgreSQL when DATABASE_URL env var is present (Render / Supabase)
...
# WhiteNoise: serve static files efficiently without a separate CDN
